...
namespace Project2_EntityFrameworkDbFirstProduct
{
    public partial class FrmProduct : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            tblProduct.ProductStock = int.Parse(txtProductStoc.Text);
            tblProduct.ProductName = txtProductAdi.Text;
            tblProduct.CategoryId = int.Parse(cbProductCategory.SelectedValue.ToString());
        ...
        {
            var values = db.TblProduct.Find(int.Parse(txtProductId.Text));
            values.ProductPrice = decimal.Parse(txtProductPrice.Text);
            values.ProductStock = int.Parse(txtProductStoc.Text);
            values.ProductName = txtProductAdi.Text;
            values.CategoryId = int.Parse(cbProductCategory.SelectedValue.ToString());
            db.SaveChanges();
            ProductList();
        }
        ...
        private void FrmProduct_Load(object sender, EventArgs e)
        {
            ...
            cbProductCategory.DataSource = values;
        }
        ...
        {
            var value = db.TblProduct.Where(x => x.ProductName == txtProductAdi.Text).ToList();
